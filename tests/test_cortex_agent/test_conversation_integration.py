"""Tests for the conversation integration with Strands Agent."""
...
class TestCortexAgentIntegration:
    """Tests for CortexAgent integration with Strands Agent."""
    ...
    async def test_async_process(
        ...
        # Create a conversation input with mock context
        context = MagicMock()
