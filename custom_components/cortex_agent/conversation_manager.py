...
from .models import MessageRole, Message, ConversationEntry
...
class ConversationManager:
    ...
    async def get_conversation_with_memories(self, conversation_id: str, memory_handler) -> List[Dict[str, Any]]:
